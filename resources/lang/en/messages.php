<?php return array (
  ...
  'Minimum_order_for_this_shipping_method_is_' => 'Minimum order for this shipping method is ',
  ...
  'min_order' => 'Min order',
  'Minimum_order_for_this_shipping_method_is_:_amount' => 'Minimum order for this shipping method is : amount',
  'Minimum_order_for_this_shipping_method_is_:amount' => 'Minimum order for this shipping method is :amount',
  'Minimum_order_for_this_shipping_method_is_ :amount' => 'Minimum order for this shipping method is  :amount',
  'Minimum_order_for_this_shipping_method_is :amount' => 'Minimum order for this shipping method is :amount',
  'No_shipping_method_found' => 'No shipping method found',
  'No_shipping_method_found_._please_contact_support' => 'No shipping method found . please contact support',
  'No_shipping_method_found._please_contact_support' => 'No shipping method found. please contact support',
  'No_shipping_method_found._Please_contact_support' => 'No shipping method found. Please contact support',
  'employee Add' => 'Employee Add',
  'add_New_Employee' => 'Add New Employee',
  'full_Name' => 'Full Name',
  ...
  'shipping_method_is_invalid' => 'Shipping method is invalid',
  'No_shipping_method_found._Please_select_a_shipping_method' => 'No shipping method found. Please select a shipping method',
  'No_shipping_method_found._Please_contact_the_support.' => 'No shipping method found. Please contact the support.',
  'Minimum_order_for_your_shipping_method_is_' => 'Minimum order for your shipping method is ',
  ...
  'Maximum_order_for_this_product_is_' => 'Maximum order for this product is ',
  'Product_added_successfully' => 'Product added successfully',
  'Image_Not_found' => 'Image Not found',
  'only' => 'only',
  'egp' => 'EGP',
  'cart_refreshed_due_to_a_problem' => 'Cart refreshed due to a problem',
  ...
  'brand_sort_order_updated_failed' => 'Brand sort order updated failed',
  'customer_Delete_Requests' => 'Customer Delete Requests',
  'customer_delete_requests' => 'Customer delete requests',
  'Your_account_delete_request_is_already_sent_to_admin' => 'Your account delete request is already sent to admin',
  'unflag' => 'Unflag',
  'cancel_request' => 'Cancel request',
  'delete_user' => 'Delete user',
  'Cancel_request' => 'Cancel request',
  'Delete_user' => 'Delete user',
  'want_to_cancel_this_request' => 'Want to cancel this request',
  'customer_delete_request_unflagged_successfully' => 'Customer delete request unflagged successfully',
  'customer_deleted_successfully' => 'Customer deleted successfully',
  'Cashback_Levels' => 'Cashback Levels',
  'cashback_levels' => 'Cashback levels',
  'cashback_level_Add' => 'Cashback level Add',
  'cashback_level_setup' => 'Cashback level setup',
  'cashback_level_type' => 'Cashback level type',
  'select_cashback_level_type' => 'Select cashback level type',
  'cashback_level_title' => 'Cashback level title',
  'cashback_level_code' => 'Cashback level code',
  'cashback_level_bearer' => 'Cashback level bearer',
  'select_cashback_level_bearer' => 'Select cashback level bearer',
  'cashback_level_desc' => 'Cashback level desc',
  'level_desc' => 'Level desc',
  'cashback_level_list' => 'Cashback level list',
  'search_by_Title_or_Description' => 'Search by Title or Description',
  'title_is_required!' => 'Title is required!',
  'level_desc_is_required!' => 'Level desc is required!',
  'min_order_is_required!' => 'Min order is required!',
  'percentage_is_required!' => 'Percentage is required!',
  'min_order_is_already_taken!' => 'Min order is already taken!',
  'want_to_delete_this_cashback_level ' => 'Want to delete this cashback level ',
  'وفر 10% لما تشتري ب 5000 جنيه' => 'وفر 10% لما تشتري ب 5000 جنيه',
  'Cashback' => 'Cashback',
  'cashback_level_Edit' => 'Cashback level Edit',
  'cashback_level_update' => 'Cashback level update',
  'Cashback_Level_updated_successfully' => 'Cashback Level updated successfully',
  'cashback_level_deleted_successfully' => 'Cashback level deleted successfully',
  'اشتري ب 5000 جنيه عشان تاخد 10% كاش باك' => 'اشتري ب 5000 جنيه عشان تاخد 10% كاش باك',
  ...
  'set_the_minimum_order_qty_a_customer_must_order_from_the_inhouse_shop' => 'Set the minimum order qty a customer must order from the inhouse shop',
  ...
  'votes' => 'Votes',
  'vote' => 'Vote',
  'vote_Setup' => 'Vote Setup',
  'currently_you_are_managing_votes_for_' => 'Currently you are managing votes for ',
  'if_you_change_theme_from_theme_setup_these_votes_will_not_be_shown_in_changed_theme._You_have_upload_all_the_votes_over_again _according_to_the_new_theme_ratio_and_sizes._If_you_switch_back_to_' => 'If you change theme from theme setup these votes will not be shown in changed theme. You have upload all the votes over again  according to the new theme ratio and sizes. If you switch back to ',
  'vote_form' => 'Vote form',
  'vote_type' => 'Vote type',
  'main_vote' => 'Main vote',
  'popup_vote' => 'Popup vote',
  'app_Popup_vote' => 'App Popup vote',
  'footer_vote' => 'Footer vote',
  'main_Section_vote' => 'Main Section vote',
  'vote_URL' => 'Vote URL',
  'vote_image' => 'Vote image',
  'vote_Image_ratio_is_not_same_for_all_sections_in_website' => 'Vote Image ratio is not same for all sections in website',
  'vote_table' => 'Vote table',
  'app_popup_vote' => 'App popup vote',
  'add_vote' => 'Add vote',
  'vote_published_successfully' => 'Vote published successfully',
  'vote_unpublished_successfully' => 'Vote unpublished successfully',
  'are_you_sure_delete_this_vote' => 'Are you sure delete this vote',
  'vote_deleted_successfully' => 'Vote deleted successfully',
  'search_by_words' => 'Search by words',
  'total_Answers' => 'Total Answers',
  'limited_Stocked_Products_List' => 'Limited Stocked Products List',
  'Enter_vote_question' => 'Enter vote question',
  'vote_question' => 'Vote question',
  'add_vote_answer' => 'Add vote answer',
  'Enter_vote_answer' => 'Enter vote answer',
  ...
  'vote_update_form' => 'Vote update form',
  'vote_image_ratio_is_not_same_for_all_sections_in_website' => 'Vote image ratio is not same for all sections in website',
  'vote_updated_successfully' => 'Vote updated successfully',
  'Your_vote_has_been_submitted' => 'Your vote has been submitted',
  'You_have_already_voted' => 'You have already voted',
  'messages.You_have_already_voted' => 'Messages.You have already voted',
  'banner_sort_order_updated_failed' => 'Banner sort order updated failed',
  'banner_sort_order_updated_successfully' => 'Banner sort order updated successfully',
  'total_visits' => 'Total visits',
  'sellers_page' => 'Sellers page',
  'if_enabled_sellers_page_will_be_visible_in_the_website_and_app' => 'If enabled sellers page will be visible in the website and app',
  'want_to_Turn_OFF_Sellers_page' => 'Want to Turn OFF Sellers page',
  'want_to_Turn_ON_sellers_page' => 'Want to Turn ON sellers page',
  'if_disabled_sellers_page_will_be_hidden_from_the_website_and_app' => 'If disabled sellers page will be hidden from the website and app',
  'Help Us Improve: Share Your Experience!' => 'Help Us Improve: Share Your Experience!',
  'Are you still hesitant  Let us help you make the best choice for you' => 'Are you still hesitant  Let us help you make the best choice for you',
  'not_completed_order_message' => 'Not completed order message',
  'not_completed_order_message_title' => 'Not completed order message title',
  'not_completed_order_message_description' => 'Not completed order message description',
  ...
  'feedback_categories_form' => 'Feedback categories form',
  'feedback_categories_link' => 'Feedback categories link',
  'enter_feedback_categories_Link' => 'Enter feedback categories Link',
  'feedback_categories_table' => 'Feedback categories table',
  'feedback_categories_Already_taken' => 'Feedback categories Already taken',
  'feedback_categories_inserted_Successfully.' => 'Feedback categories inserted Successfully.',
  'are_you_sure_delete_this_feedback_categories' => 'Are you sure delete this feedback categories',
  'feedback_categories_deleted_successfully.' => 'Feedback categories deleted successfully.',
  'feedback_categories_name' => 'Feedback categories name',
  'enter_feedback_categories_name' => 'Enter feedback categories name',
  'feedback_categories_title' => 'Feedback categories title',
  'enter_feedback_categories_title' => 'Enter feedback categories title',
  'title_Is_Requeired.' => 'Title Is Requeired.',
  'feedback_categories-deleted_successfully.' => 'Feedback categories-deleted successfully.',
  'للبيلب' => 'للبيلب',
  'السعر غالي' => 'السعر غالي',
  'متردد مش عارف' => 'متردد مش عارف',
  '2342لالرلال' => '2342لالرلال',
  'بدون أسباب' => 'بدون أسباب',
  'التعامل مع التطبيق صعب' => 'التعامل مع التطبيق صعب',
  'التعامل صعب' => 'التعامل صعب',
  'ليبلبليبلبيلل' => 'ليبلبليبلبيلل',
  'بسيبسيب' => 'بسيبسيب',
  'لبيبللبي' => 'لبيبللبي',
  'ابلابا' => 'ابلابا',
  'ااااا' => 'ااااا',
  'ابلابلابلابلابلابلابلا' => 'ابلابلابلابلابلابلابلا',
  'للاا' => 'للاا',
  'الاسعار' => 'الاسعار',
  'الاسعار مش حلوة' => 'الاسعار مش حلوة',
  'الاسعار اوفر' => 'الاسعار اوفر',
  'feedback_responses' => 'Feedback responses',
  'feedback_responses_form' => 'Feedback responses form',
  'feedback_responses_title' => 'Feedback responses title',
  'enter_feedback_responses_title' => 'Enter feedback responses title',
  'feedback_responses_table' => 'Feedback responses table',
  'feedback_responses_description' => 'Feedback responses description',
  'enter_feedback_responses_description' => 'Enter feedback responses description',
  'الأسعار مش حلوة بالنسبالي وغالية' => 'الأسعار مش حلوة بالنسبالي وغالية',
  'الأسعار خرا' => 'الأسعار خرا',
  'الأسعار زي الزفت والخرا والقطران' => 'الأسعار زي الزفت والخرا والقطران',
  'feedback_responses_category' => 'Feedback responses category',
  'enter_feedback_responses_category' => 'Enter feedback responses category',
  'Feedback has been submitted, Thank you' => 'Feedback responses category form',
  'Feedback has been submitted  Thank you' => 'Feedback has been submitted  Thank you',
  'الأسعار معجبتنيش وغالية' => 'الأسعار معجبتنيش وغالية',
  'ملقتش الي محتاجه غاليين' => 'ملقتش الي محتاجه غاليين',
  'No cashback level found' => 'No cashback level found',
  'No product found' => 'No product found',
