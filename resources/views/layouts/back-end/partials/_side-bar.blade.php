            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="nav-item {{(Request::is('admin/banner*') || (Request::is('admin/vote*')) || (Request::is('admin/coupon*')) || (Request::is('admin/notification*')) || (Request::is('admin/deal*')))?'scroll-here':''}}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/vote*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('admin.vote.list')}}" title="{{translate('votes')}}">
                                <i class="tio-checkmark-circle nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('votes')}}</span>
                            </a>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/coupon*') || Request::is('admin/deal*')) ?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/cashback_level') || Request::is('admin/cashback_level/edit*'))?'active':''}}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                       href="{{route('admin.cashback_level.add-new')}}"
                                       title="{{translate('Cashback_Levels')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{translate('cashback_levels')}}
                                        </span>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/feedback-categories*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('admin.business-settings.feedback_categories')}}" title="{{translate('feedback_categories')}}">
                                <i class="tio-comment-outlined nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('feedback_categories')}}</span>
                            </a>
                            
                        </li>

                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/feedback-responses*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('admin.business-settings.feedback_responses')}}" title="{{translate('feedback_responses')}}">
                                <i class="tio-comment-outlined nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('feedback_responses')}}</span>
                            </a>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/customer/wallet*') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report'))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/customer/list') || Request::is('admin/customer/view*')?'active':''}}">
                                    ...
                                    <li class="nav-item {{Request::is('admin/customer/delete_requests') || Request::is('admin/customer/view*')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.customer.delete_requests')}}"
                                       title="{{translate('Customer_List')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{translate('customer_Delete_Requests')}} </span>
                                    </a>
                                </li>
