                ...
                <div class="card-body">
                    <form action="{{route('admin.business-settings.shipping-method.update',[$method['id']])}}"
                        ...
                        <div class="form-group">
                            <div class="row ">
                                <div class="col-md-12">
                                    <label class="title-color" for="min_order">{{translate('min_order')}}</label>
                                    <input type="number" min="0" max="1000000" name="min_order" value="{{\App\CPU\BackEndHelper::usd_to_currency($method['min_order'])}}" class="form-control" placeholder="{{translate('ex')}} : {{translate('10')}}$">
                                </div>
                            </div>
                        </div>
