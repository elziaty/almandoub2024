                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group">
                                    <div class="row justify-content-center">
                                        <div class="col-md-12">
                                            <label class="title-color d-flex" for="min_order">{{translate('min_order')}}</label>
                                            <input type="number" min="0" step="0.01" max="1000000" name="min_order" class="form-control" placeholder="{{translate('ex')}} :" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table
                        ...
                        @foreach($shipping_methods as $k=>$method)
                            <tr>
                                ...
                                <td>
                                    {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($method['min_order']))}}
                                </td>
                                <td>
