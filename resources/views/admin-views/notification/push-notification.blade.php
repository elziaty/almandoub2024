                    ...
                    <div class="card-body py-5">
                        ...
                        <form action="{{route('admin.business-settings.update-fcm-messages')}}" class="text-start" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                @php($not_completed_order_message_title=\App\Model\BusinessSetting::where('type','not_completed_order_message_title')->first())
                                @php($not_completed_order_message_title = isset($not_completed_order_message_title) ? $not_completed_order_message_title->value : null
                                 )
                                @if($not_completed_order_message_title)
                                    @php($data=json_decode($not_completed_order_message_title,true))
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            <div class="d-flex align-items-center mb-3 flex-wrap gap-10 justify-content-between">
                                                <label for="not_completed_order_message_title">{{translate('not_completed_order_message_title')}}</label>  
                                                </label>
                                            </div>
                                            <textarea name="not_completed_order_message_title" class="form-control">{{$data['message']}}</textarea>
                                        </div>
                                    </div>
                                @endif

                                @php($not_completed_order_message_description=\App\Model\BusinessSetting::where('type','not_completed_order_message_description')->first())
                                @php($not_completed_order_message_description = isset($not_completed_order_message_description) ? $not_completed_order_message_description->value : null
                                 )
                                @if($not_completed_order_message_description)
                                    @php($data=json_decode($not_completed_order_message_description,true))
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-group">
                                            <div class="d-flex align-items-center mb-3 flex-wrap gap-10 justify-content-between">
                                                <label for="not_completed_order_message_description">{{translate('not_completed_order_message_description')}}</label>  
                                                </label>
                                            </div>
                                            <textarea name="not_completed_order_message_description" class="form-control">{{$data['message']}}</textarea>
                                        </div>
                                    </div>
                                @endif
