            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="maximum_order_qty">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0" for="maximum_order_qty">{{ translate('maximum_order_qty') }}</label>

                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"  title="{{translate('set_the_maximum_order_quantity_that_customers_must_choose._Otherwise,_the_checkout_process_won’t_start')}}.">
                                        <img src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="">
                                    </span>
                                </div>

                                <input type="number" min="01" value="0" step="1" placeholder="{{ translate('minimum_order_quantity') }}" name="maximum_order_qty" id="maximum_order_qty" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3" id="maximum_order_time">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0" for="maximum_order_time">{{ translate('maximum_order_time') }}</label>
                                ...
                                <input type="number" min="0" value="0" step="1" placeholder="{{ translate('minimum_order_quantity') }}" name="maximum_order_time" id="maximum_order_time" class="form-control" required>
                            </div>
                        </div>
