                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="maximum_order_qty">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color" for="maximum_order_qty">{{ translate('maximum_order_qty') }}</label>
                                ...
                                <input type="number" min="0" value="{{ $product->maximum_order_qty }}" step="1"
                                        placeholder="{{translate('minimum_order_quantity') }}"
                                        name="maximum_order_qty" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3" id="maximum_order_time">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color" for="maximum_order_time">{{ translate('maximum_order_time') }}</label>
                                ...
                                <input type="number" min="0" value="{{ $product->maximum_order_time }}" step="1"
                                        placeholder="{{translate('minimum_order_quantity') }}"
                                        name="maximum_order_time" class="form-control" required>
                            </div>
                        </div>
