<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="{{ Request::is('admin/business-settings/page/sales-policy') ?'active':'' }}"><a href="{{route('admin.business-settings.page',['sales-policy'])}}">{{translate('sales_Policy')}}</a></li>
