            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            @php($deal_of_the_day=\App\CPU\Helpers::get_business_settings('deal_of_the_day'))
                            <!-- phone verification is deal of the day -->
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                    <span class="title-color">
                                        {{translate('deal_of_the_day')}}
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right" title="{{translate('if_enabled_deal_of_the_day_will_be_visible_in_the_website_and_app')}}">
                                            <img width="16" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="">
                                        </span>
                                    </span>

                                    <label class="switcher" for="deal_of_the_day"onclick="toogleModal(event,'deal_of_the_day','deal-of-the-day-status-off.png','deal-of-the-day-status-on.png','{{translate('want_to_Turn_OFF_Deal_Of_The_Day')}}','{{translate('want_to_Turn_ON_deal_of_the_day')}}',`<p>{{translate('if_disabled_deal_of_the_day_will_be_hidden_from_the_website_and_app')}}</p>`,`<p>{{translate('if_enabled_deal_of_the_day_will_be_visible_in_the_website_and_app')}}</p>`)">
                                        <input type="checkbox" class="switcher_input" name="deal_of_the_day" id="deal_of_the_day" value="1" {{ $deal_of_the_day == 1 ? 'checked':'' }}>
                                        <span class="switcher_control"></span>
                                    </label>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            @php($sellers_page=\App\CPU\Helpers::get_business_settings('sellers_page'))
                            <!-- phone verification is deal of the day -->
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                    <span class="title-color">
                                        {{translate('sellers_page')}}
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right" title="{{translate('if_enabled_sellers_page_will_be_visible_in_the_website_and_app')}}">
                                            <img width="16" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="">
                                        </span>
                                    </span>

                                    <label class="switcher" for="sellers_page"onclick="toogleModal(event,'sellers_page','deal-of-the-day-status-off.png','deal-of-the-day-status-on.png','{{translate('want_to_Turn_OFF_Sellers_page')}}','{{translate('want_to_Turn_ON_sellers_page')}}',`<p>{{translate('if_disabled_sellers_page_will_be_hidden_from_the_website_and_app')}}</p>`,`<p>{{translate('if_enabled_sellers_page_will_be_visible_in_the_website_and_app')}}</p>`)">
                                        <input type="checkbox" class="switcher_input" name="sellers_page" id="sellers_page" value="1" {{ $sellers_page == 1 ? 'checked':'' }}>
                                        <span class="switcher_control"></span>
                                    </label>
                                </div>
