                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100" name="banner_type" required id="banner_type_select">
                                            ...
                                            <option value="App Popup Banner">{{ translate('app_Popup_Banner')}}</option>
                                            ...
                                            <div class="row gy-2 gx-2 align-items-center text-left">
                                                <div class="col-sm-12 col-md-9">
                                                    <select class="form-control __form-control" name="search" id="date_type">
                                                        ...
                                                        <option value="App Popup Banner" {{ $search == "App Popup Banner" ? 'selected':'' }}>{{ translate('app_popup_Banner')}}</option>
                                                        @if(theme_root_path() != 'theme_fashion')
                    ...
                    <div class="table-responsive">
                        <table id="columnSearchDatatable"
                            ...
                            @foreach($banners as $key=>$banner)
                                <tr  data-id="{{$banner->id}}"  id="data-{{$banner->id}}">
        ...
        function sendOrderToServer(){
            ...
            $.ajax({
                ...
                error: function(response){
                    toastr.error("Banner sort order updated failed");
                }
            });
        }
    </script>
