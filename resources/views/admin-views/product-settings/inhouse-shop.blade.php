    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @if ($minimum_order_amount_status || $free_delivery_status || $minimum_order_qty_status)
                <div class="mt-5">
                        ...
                        <div class="bg-white rounded border">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    @php($minimum_order_qty=\App\CPU\Helpers::get_business_settings('minimum_order_qty'))
                                    @if ($minimum_order_qty_status)
                                    <div class="col-lg-4 col-mg-6">
                                        <div class="form-group">
                                            <label class="title-color d-flex" for="minimum_order_qty">
                                                {{translate('minimum_order_qty')}}
                                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right" title="{{translate('set_the_minimum_order_qty_a_customer_must_order_from_the_inhouse_shop')}}">
                                                    <img width="16" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="">
                                                </span>
                                            </label>
                                            <input type="number" min="0" class="form-control" name="minimum_order_qty" id="minimum_order_qty" placeholder="{{translate('ex')}}: 10" value="{{\App\CPU\Convert::default($minimum_order_qty) }}">
                                        </div>
                                    </div>
                                    @endif
