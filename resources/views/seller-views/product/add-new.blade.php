                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="maximum_order_qty">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="0" step="1" placeholder="{{ translate('minimum_order_quantity') }}" name="maximum_order_qty" id="maximum_order_qty" class="form-control" required>
                            </div>
                        </div>
