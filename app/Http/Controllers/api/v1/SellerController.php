...
class SellerController extends Controller
{
    ...
    public function get_seller_info(Request $request)
    {
        ...
        // add visit count 
        CustomerManager::view_shop_visit($seller->shop->id,'app', auth('customer')->id());
    ...
    public function get_visits( Request $request)
    {
        ...
        $seller = Seller::with(['shop'])->where(['id' => $request['seller_id']])->first(['id']);
 
        $counter =  CustomerManager::get_shop_visits($seller->shop->id, $source, $date_type, $from, $to);
        return [
            'counter' => $counter,
            'source'  => $source 
        ];
