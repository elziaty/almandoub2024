...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'maximum_order_qty'    => 'required|numeric',
            'maximum_order_time'   => 'required|numeric'
        ], [
        ...
        $p->maximum_order_qty = $request->maximum_order_qty;
        $p->maximum_order_time = $request->maximum_order_time;
    ...
    public function export_excel(Request $request, $type){
        ...
        foreach ($products as $item) {
            ...
            $data[] = [
                ...
                'maximum_order_qty'               => $item->maximum_order_qty,
                'maximum_order_time'              => $item->maximum_order_time,
    ...
    public function update(Request $request, $id)
    {
        ...
        $product->maximum_order_qty     = $request->maximum_order_qty;
        $product->maximum_order_time    = $request->maximum_order_time;
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        $data = [];
        $col_key = ['name', 'category_id', 'sub_category_id', 'sub_sub_category_id', 'brand_id', 'unit', 'minimum_order_qty','maximum_order_time', 'maximum_order_qty', 'refundable', 'youtube_video_url', 'unit_price', 'purchase_price', 'tax', 'discount', 'discount_type', 'current_stock', 'details', 'thumbnail'];
        ...
        foreach ($collections as $collection) {
            ...
            array_push($data, [
                ...
                'maximum_order_qty' => $collection['maximum_order_qty'],
                'maximum_order_time' => $collection['maximum_order_time'],
