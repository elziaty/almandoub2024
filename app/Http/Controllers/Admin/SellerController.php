...
class SellerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $sellers = Seller::with(['orders', 'product'])
            ...
            $sellers->map(function($seller){
                $seller->visits = CustomerManager::get_shop_visits($seller->shop->id);
            });
    ...
    public function view(Request $request, $id, $tab = null)
    {
        ...
        $counter = CustomerManager::get_shop_visits($seller->shop->id);

        return view('admin-views.seller.view', compact('seller','current_date','counter'));
    }
