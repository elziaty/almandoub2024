...
class ProductController extends Controller
{
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        $data = [];
        $col_key = ['name', 'category_id', 'sub_category_id', 'sub_sub_category_id', 'brand_id', 'unit', 'minimum_order_qty','maximum_order_qty','maximum_order_time', 'refundable', 'youtube_video_url', 'unit_price', 'purchase_price', 'tax', 'discount', 'discount_type', 'current_stock', 'details', 'thumbnail'];
