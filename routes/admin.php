...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            Route::get('feedback_categories', 'BusinessSettingsController@feedback_categories')->name('feedback_categories');
            Route::get('feedback_categories_fetch', 'BusinessSettingsController@feedback_categories_fetch')->name('feedback_categories_fetch');
            Route::post('feedback_categories-store', 'BusinessSettingsController@feedback_categories_store')->name('feedback_categories-store');
            Route::post('feedback_categories-edit', 'BusinessSettingsController@feedback_categories_edit')->name('feedback_categories-edit');
            Route::post('feedback_categories-update', 'BusinessSettingsController@feedback_categories_update')->name('feedback_categories-update');
            Route::post('feedback_categories-delete', 'BusinessSettingsController@feedback_categories_delete')->name('feedback_categories-delete');
            Route::post('feedback_categories-status-update', 'BusinessSettingsController@feedback_categories_status_update')->name('feedback_categories-status-update');

            Route::get('feedback_responses', 'BusinessSettingsController@feedback_responses')->name('feedback_responses');
            Route::get('feedback_responses_fetch', 'BusinessSettingsController@feedback_responses_fetch')->name('feedback_responses_fetch');
            Route::get('feedback_responses_show', 'BusinessSettingsController@feedback_responses_show')->name('feedback_responses_show');
        ...
        Route::group(['prefix' => 'brand', 'as' => 'brand.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('sort', 'BrandController@sort')->name('sort');
        });
        ...
        Route::group(['prefix' => 'vote', 'as' => 'vote.','middleware'=>['module:promotion_management']], function () {
            Route::post('add-new', 'VotesController@store')->name('store');
            Route::get('list', 'VotesController@list')->name('list');
            Route::post('delete', 'VotesController@delete')->name('delete');
            Route::post('status', 'VotesController@status')->name('status');
            Route::get('edit/{id}', 'VotesController@edit')->name('edit');
            Route::put('update/{id}', 'VotesController@update')->name('update');
            Route::post('answer/delete/', 'VotesController@answer_delete')->name('answer.delete');
        });
        ...
        Route::group(['prefix' => 'cashback_level', 'as' => 'cashback_level.','middleware'=>['module:promotion_management']], function () {
            Route::get('add-new', 'CashBackController@add_new')->name('add-new')->middleware('actch');
            Route::post('store-level', 'CashBackController@store')->name('store-level');
            Route::get('update/{id}', 'CashBackController@edit')->name('update')->middleware('actch');
            Route::post('update/{id}', 'CashBackController@update');
            Route::get('quick-view-details', 'CashBackController@quick_view_details')->name('quick-view-details');
            Route::get('status/{id}/{status}', 'CashBackController@status')->name('status');
            Route::delete('delete/{id}', 'CashBackController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('delete_requests', 'CustomerController@customer_delete_requests')->name('delete_requests');
            Route::post('shipping-method-update', 'CustomerController@update_shipping_method')->name('update_shipping_method');
            Route::post('password-update', 'CustomerController@update_password')->name('update_password');
            ...
            Route::post('unflag-delete-request/{id}','CustomerController@unflag_delete_request')->name('unflag-delete-request');
